<template>
  <div class="navbarSec">
        ...
        <div class="row navbardetail" dir="rtl">
            <h1>
                گل ها شیوه ی طبیعت <br> برای سرودن <span>شعر</span> هستند
            </h1>
        </div>
        <div class="navbarSec2" dir="rtl">
            <table>
                <tr>
                    <td class="item1">
                    ...
                    <td v-for="item in SecNavItem" :key="item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" :class="item.class" viewBox="0 0 16 16">
                            <path :d="item.d"/>
                          </svg>
                    {{ item.name }}
                    </td>
